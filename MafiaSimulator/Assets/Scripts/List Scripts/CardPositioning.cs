...
public class CardPositioning : MonoBehaviour
{
    ...
    private void Update()
    {
        foreach(GameObject card in Card)
        {
            ...
            //as long as the verb area is active the first slot snap works
            if(aSlot_Control.sAreaActive == true || eSlot_Control.sAreaActive == true || iSlot_Control.sAreaActive == true || sSlot_Control.sAreaActive == true)
            {
                ///Slot 1 Snap
                ...
                if (aSlot_Control.slot2Active == true || eSlot_Control.slot2Active == true || iSlot_Control.slot2Active == true || sSlot_Control.slot2Active == true)
                {
                    ///Slot 2 Snap
                ...
                if (aSlot_Control.slot3Active == true || eSlot_Control.slot3Active == true || iSlot_Control.slot3Active == true || sSlot_Control.slot3Active == true)
                {
                    ///Slot 3 Snap
                ...
                if (aSlot_Control.slot4Active == true || eSlot_Control.slot4Active == true || iSlot_Control.slot4Active == true || sSlot_Control.slot4Active == true)
                {
                    ///Slot 4 Snap
